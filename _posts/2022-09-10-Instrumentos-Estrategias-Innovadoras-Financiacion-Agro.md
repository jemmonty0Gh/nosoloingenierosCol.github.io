...
<img src="{{ site.url }}/assets/images/CFonseca_IAC_deuda.png" width="400px">
{% include image.html url="/images/CFonseca_IAC_deuda.png" width="400px" description="Proyeccion de Deuda Publica" %}
